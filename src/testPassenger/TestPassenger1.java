...
public class TestPassenger1 {
	public static void main(String[] args) {
		...
		passengerRecord record1 = new passengerRecord("Johann", "Cardona", "01/04/2001", "01213823433", "2007048@brunel.ac.uk", 4, "A1", "A2");
		passengerRecord record2 = new passengerRecord("Miguel", "Quevedo", "04/06/2003", "27878127841", "2375732@brunel.ac.uk", 2, "A4", "A6");
		...
		System.out.println(data1.getPassengerRecord(0).getTelNumber());
		...
		System.out.println(data2.getPassengerRecord(0).getTelNumber());
