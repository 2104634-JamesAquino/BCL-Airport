...
public class seatsOfPlan {
	...
	public static double fDuration = 20;
	/*
	...
	public static void main(String[] args) {
		 ...
		 */
		seatsOfPlan Alg1 = new seatsOfPlan();
		Alg1.longAndShortHaulFlights();

		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					seatsOfPlan window = new seatsOfPlan();
	...
	public void initialize() { /* the UI creation */
		...
		JButton btn5B_A = new JButton("5B");
...
//test
		...
		btn5B_A.setBackground(Color.RED);
